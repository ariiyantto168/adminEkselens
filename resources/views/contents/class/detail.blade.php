                      ...
                      <div class="card-body">
                          <table class="table table-bordered">
                              <tbody>
                                ...
                                <tr>
                                    <td width="20%"><strong>Mitra</strong></td>
                                    <td>
                                        @if ($class->namemitra)
                                            {{$class->namemitra}}
                                        @else
                                ...
                                <tr>
                                    <td width="20%"><strong>Description Mitra</strong></td>
                                    <td>
                                        @if ($class->descriptionmitra)
                                            {{$class->descriptionmitra}}
                                        @else
                                           Not Available 
                                        @endif
                                    </td>
                                ...
                                <tr>
                                  ...
                                  <tr>
                                    <td width="20%"><strong>Images Mitra</strong></td>
                                    <td>
                                        @if ($class->imagesmitra)
                                        <img  src="{{$class->url_imagesmitra}}" alt="..." class="img-thumbnail" style="border-radius: 4px; padding: 5px; width: 150px;"  width="80" height="30">
                                        @else
                                           Not Available 
                                        @endif
                                    </td>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      <img  src="{{$class->url_imagesinstructor}}" alt="..." class="img-thumbnail" style="border-radius: 4px; padding: 5px; width: 150px;"  width="80" height="30">
                                    </td> 
                                </tr>
                                  <tr>
                                      <td width="20%"><strong> Image Class</strong></td>
                                      <td>
                                        <img  src="{{$class->url_images}}" alt="..." class="img-thumbnail" style="border-radius: 4px; padding: 5px; width: 150px;"  width="80" height="30">
                                      </td> 
                                  </tr>
                                  <tr>
                                      <td width="20%"><strong> Demo Class</strong></td>
                                      <td>
                                        <iframe  src="{{$class->url_demo}}" frameborder="0"></iframe>
                                      </td> 
                                  </tr>
                              </tbody>
                          </table>
                  ...
                  success: function (response) {
                      ...
                      $.each(response.subclass.materies, function( index, value ) {
                          content +=  '<tr id="remove_'+value.idmateries+'">'
                                      ...
                                      +'<td><iframe src="'+value.url_video_480+'" frameborder="0"></iframe> </td>'
                                      +'<td><iframe src="'+value.url_video_720+'" frameborder="0"></iframe> </td>'
                                      +'</tr>'
                      });
