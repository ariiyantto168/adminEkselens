...
Route::get('lecture/class/update/{class}', [ClassController::class, 'update_page'])->middleware('check.auth');
Route::post('lecture/class/update/{class}', [ClassController::class, 'update_save'])->middleware('check.auth');
Route::delete('lecture/class/delete/{class}', [ClassController::class, 'delete_class'])->middleware('check.auth');
